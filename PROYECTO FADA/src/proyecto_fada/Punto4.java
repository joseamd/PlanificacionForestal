...
public class Punto4 {
    ...
    private void Sumar(Rodal valorAcomparar) {
        ...
        if (NumeroArbolesTemporal <= Umbral_a_Evaluar) {
    ...
    public void Comparar() {
        if (NumeroArbolesTemporal > maximoNumeroArboles) {
 ...
 el costo total y el numero total de arboles que seran talados en todos los rodales que esten      * delante de el y no se solapen
    ...
    public void solucionPunto4() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "El tiempo que tomo la ejecucion del punto4 fue de: " + tiempoFinal + " milisegundos.");
        } catch (Exception ex) {            
            System.out.println("error");
        }   
    }
